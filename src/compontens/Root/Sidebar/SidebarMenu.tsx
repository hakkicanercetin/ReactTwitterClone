    ...
    return(
        <nav className="mt-0.5 mb-1">
            <NavLink to={"/"} className="py-1 block group">
                <div className="p-3 rounded-full inline-flex transition-colors items-center gap-5 group-hover:bg-[#eff3f41a]">
                    <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                        <path fill="#fff" d="M21.591 7.146L12.52 1.157c-.316-.21-.724-.21-1.04 0l-9.071 5.99c-.26.173-.409.456-.409.757v13.183c0 .502.418.913.929.913H9.14c.51 0 .929-.41.929-.913v-7.075h3.909v7.075c0 .502.417.913.928.913h6.165c.511 0 .929-.41.929-.913V7.904c0-.301-.158-.584-.408-.758z"></path>
                    </svg>
            ...
            <NavLink to={"/"} className="py-1 block group">
                <div className="p-3 rounded-full inline-flex transition-colors items-center gap-5 group-hover:bg-[#eff3f41a]">
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path fill="#fff" d="M1.998 5.5c0-1.381 1.119-2.5 2.5-2.5h15c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5h-15c-1.381 0-2.5-1.119-2.5-2.5v-13zm2.5-.5c-.276 0-.5.224-.5.5v2.764l8 3.638 8-3.636V5.5c0-.276-.224-.5-.5-.5h-15zm15.5 5.463l-8 3.636-8-3.638V18.5c0 .276.224.5.5.5h15c.276 0 .5-.224.5-.5v-8.037z"></path>
                </svg>
                    <div className="pr-4 text-xl">
                        Messages
                    </div>
            ...
            <NavLink to={"/"} className="py-1 block group">
                <div className="p-3 rounded-full inline-flex transition-colors items-center gap-5 group-hover:bg-[#eff3f41a]">
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    <path fill="#fff" d="M3 4.5C3 3.12 4.12 2 5.5 2h13C19.88 2 21 3.12 21 4.5v15c0 1.38-1.12 2.5-2.5 2.5h-13C4.12 22 3 20.88 3 19.5v-15zM5.5 4c-.28 0-.5.22-.5.5v15c0 .28.22.5.5.5h13c.28 0 .5-.22.5-.5v-15c0-.28-.22-.5-.5-.5h-13zM16 10H8V8h8v2zm-8 2h8v2H8v-2z"></path>
                </svg>
                    <div className="pr-4 text-xl">
                        Lists
                    </div>
            ...
            <NavLink to={"/bookmarks"} className="py-1 block group">
                <div className="p-3 rounded-full inline-flex transition-colors items-center gap-5 group-hover:bg-[#eff3f41a]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        {savedTweets.length > 0 && <span className="w-[18px] h-[18px] rounded-full bg-[#1f9bf0] absolute -top-1.5 -right-1 flex items-center justify-center text-[11px]">{savedTweets.length}</span> }
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
